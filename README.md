...
For including all seasonal dummies for some models could be tried (instead of omitting one category), just use function seasall which is at the beginning of the maininf f.R (an small variation on seasonaldummy) instead of seasonaldummy (https://pkg.robjhyndman.com/forecast/reference/seasonaldummy.html) :
